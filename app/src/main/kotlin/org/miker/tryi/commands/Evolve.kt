...
import org.miker.tryi.Evolver
import org.miker.tryi.GeneratedPreview
import org.miker.tryi.MultiParentEvolver
import org.miker.tryi.SingleParentEvolver
...
class Evolve : CliktCommand(help = "Evolve a tryi.") {
    ...
    private val triangles: Int by option("-t", "--triangles", help="How many triangles in the tryi.")
        .int().default(Evolver.NUM_TRIANGLES)
